...
@section('title', 'Subir Historial Clíncio')
                            ...
                            <div class="col-md-12" style="height: 50px !important">
                                <div class="mb-5">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" style="border-radius:0px 0px 0px 0px !important; height:38px" maxlength="8" minlength="8" id="dni" name="dni" aria-describedby="basic-addon3 basic-addon4">
                                        <button id="searchButton" class="btn btn-primary" type="button" style="background-color: #00476D !important;height:38px">
                            ...
                            <div class="row g-3 mt-1" style="justify-content:center">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <select title="...."  data-size="3" data-live-search="true"
                                        class="form-control selectpicker show-tick bg-secondary" id="id_specialization" name="id_specialization">
                                            @foreach ($specializations as $specialization)
                                                <option value="{{ $specialization->id }}" {{ old('id_specialization') == $specialization->id ? 'selected' : '' }}>
                                                    {{ $specialization->name }}
                                                </option>
                                            @endforeach
                                        </select>
    ...
    @push('js')
        ...
        <script>
            ...
            // Permitir solo números en los campos de DNI y teléfono

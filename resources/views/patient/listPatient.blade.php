                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    <a href="{{ url('admin/patient/edit/' . $patient->slug) }}" class="btn btn-primary" style="background: #7BDE7C;"><i class="fas fa-pencil-alt"></i></a>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="{{url('admin/patient/delete/'.$patient->id)}}" class="btn btn-danger"style="background: #EB5C5E;">
                                                                        Eliminar
                                                                    </a>
                                                                </div>
                                                            </div>

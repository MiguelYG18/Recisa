                            ...
                            <div class="row">
                                <div class="col-md-6 mt-2">
                                    <div class="input-group">
                                        ...
                                        <select name="id_patient" id="id_patient" title="Seleccione..." data-style="btn-secondary" data-live-search="true" data-size="3" class="form-control selectpicker">
                                                @foreach ($patients as $patient)
                                                   <option value="{{$patient->id}}">{{$patient->surnames}}, {{$patient->names}}</option>
                                                @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-2">
                                    <div class="input-group">
                                        ...
                                        <select name="id_quota" id="id_quota" data-style="btn-secondary" data-live-search="true" data-size="3" class="form-control selectpicker">
                                                    ...
                                                    <optgroup label="{{ $quota->user->surnames }}, {{ $quota->user->names}} -> cupos: {{$quota->cupo_doctor}}">
                                                        @foreach ($quotas as $specialization)
                                                            @if ($specialization->id_specialization == $quota->id_specialization)
                                                                <option value="{{ $specialization->id }}" {{ old('id_quota') == $specialization->id ? 'selected' : '' }} {{ $specialization->cupo_doctor == 0 ? 'disabled' : '' }}>
                                ...
                                <div class="col-md-6 text-center mt-2">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" name="date" id="date" class="form-control boder-success" value="{{old('date')}}">
                                    </div>
                                </div>  
                                <!--hora-->
                                <div class="col-md-6 text-center mt-2">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="time" name="time" id="time" class="form-control boder-success" value="{{old('time')}}">
                                    </div>
                                </div>                                
